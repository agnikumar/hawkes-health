function model = Exp1_Learning_MLE_ODE(Seqs, model, alg)
                                                        
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%
% Adding error calculations for g to Learning_MLE_ODE
%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%         end    
    ...
    % added (ODE log-likelihood calculation)
    if alg.storeLL
        Loglike = Loglike_HP_ODE(Seqs, model, alg);
        model.LL(o) = Loglike;
    end
    
    % added (g error calculation)
    if alg.storeErr
        Err = zeros(1,1);
        ...
        Err(1) = (Kernel_Integration_Approx(model.dt, model_ODE_eval)) / ...
