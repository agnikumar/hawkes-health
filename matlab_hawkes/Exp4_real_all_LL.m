...
alg.LowRank = 1; % on
alg.Sparse = 0; % on
alg.alphaLR = 100; %0.2; %0.1; % grid search, lambda_1, between 0 and 0.2
alg.alphaS = 2; %0.004; %0.001; %1; % grid search, lambda_2, between 0 and 0.002
alg.alphaLR_mu = 50; %0.004; %0.001; %0.5; % added, grid search, lambda_3, between 0 and 0.002
...
nSeg = 20; % number of chunks of data
nNum = U/nSeg;
for i = 1:nSeg
